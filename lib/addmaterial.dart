...
import 'package:storehelper/sellermainscreen.dart';
...
class AddMaterialScreen extends StatefulWidget {
  ...
  const AddMaterialScreen({Key key, this.user}) : super(key: key);
  @override
...
class _AddMaterialScreenState extends State<AddMaterialScreen> {
 ...
 Future _chooseCamera() async {
  ...
  void _postuserGram() {
    ...
    http.post(
        Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/newmaterial.php"),
        body: {
            "name": name,
            "type": type,
            "price": price,
