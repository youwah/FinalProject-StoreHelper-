...
class SellerPromotionListScreen extends StatefulWidget {
  final User user;

  const SellerPromotionListScreen({Key key, this.user}) : super(key: key);
  
  @override
  _SellerPromotionListScreenState createState() => _SellerPromotionListScreenState();
}

class _SellerPromotionListScreenState extends State<SellerPromotionListScreen> {
  ...
  @override
   Widget build(BuildContext context) {
    ...
    return WillPopScope(
                            ...
                            child: Container(
                                ...
                                decoration: new BoxDecoration(
                                    ...
                                    image: new DecorationImage(
                                        fit: BoxFit.cover,
                                        image: new NetworkImage("https://crimsonwebs.com/s272043/storehelper/imagespromotion/${_productList[index]['id']}.png")))
                                        ),
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.push(
            context, MaterialPageRoute(builder: (context)=>AddPromotionScreen(user: widget.user,))
          );
        },
   ...
   void _loadGrams(String prname) {
    http.post(
        Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/loadpromotelist.php"),
         body: {"prname": prname}
        ).then((response) {
