...
class SellerMaterialListScreen extends StatefulWidget {
  final User user;

  const SellerMaterialListScreen({Key key, this.user}) : super(key: key);
  
  @override
  _SellerMaterialListScreenState createState() => _SellerMaterialListScreenState();
}

class _SellerMaterialListScreenState extends State<SellerMaterialListScreen> {
  ...
  @override
   Widget build(BuildContext context) {
    ...
    return WillPopScope(
                            ...
                            child: Container(
                                ...
                                decoration: new BoxDecoration(
                                    ...
                                    image: new DecorationImage(
                                        fit: BoxFit.cover,
                                        image: new NetworkImage("https://crimsonwebs.com/s272043/storehelper/imagesmaterial/${_productList[index]['id']}.png")))
                                        ),
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.push(
            context, MaterialPageRoute(builder: (context)=>AddMaterialScreen(user: widget.user,))
          );
        },
   ...
   void _loadGrams(String prname) {
    http.post(
        Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/loadmaterial.php"),
         body: {"prname": prname}
        ).then((response) {
