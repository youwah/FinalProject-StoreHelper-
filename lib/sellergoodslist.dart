...
class SellerGoodsListScreen extends StatefulWidget {
  final User user;

  const SellerGoodsListScreen({Key key, this.user}) : super(key: key);
  
  @override
  _SellerGoodsListScreenState createState() => _SellerGoodsListScreenState();
}

class _SellerGoodsListScreenState extends State<SellerGoodsListScreen> {
  ...
  @override
   Widget build(BuildContext context) {
    ...
    return WillPopScope(
                            ...
                            child: Container(
                                ...
                                decoration: new BoxDecoration(
                                    ...
                                    image: new DecorationImage(
                                        fit: BoxFit.cover,
                                        image: new NetworkImage("https://crimsonwebs.com/s272043/storehelper/imagesgoods/${_productList[index]['id']}.png")))
                                        ),
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.push(
            context, MaterialPageRoute(builder: (context)=>AddGoodsScreen(user: widget.user,))
          );
        },
   ...
   void _loadGrams(String prname) {
    http.post(
        Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/loadgoods.php"),
         body: {"prname": prname}
        ).then((response) {
