...
class PromotionListScreen extends StatefulWidget {
  ...
  const PromotionListScreen({Key key, this.user}) : super(key: key);
...
class _PromotionListScreenState extends State<PromotionListScreen> {
  ...
  _addtofav(int index) async {
   
      String prid = _productList[index]['id'];
      http.post(Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/insertfavorite.php"),
