...
class _RegisterSellerScreenState extends State<RegisterSellerScreen> {
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(labelText: 'Country',icon: Icon(Icons.add_location)),
              obscureText: true,
              ),
              TextField(
    ...
    http.post(Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/register_seller.php"),
                              body: {
                                "email":email,
                                "password":password,
                                "name":name,
