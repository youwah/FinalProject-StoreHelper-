...
class EditSellerProfilePage extends StatefulWidget {
  ...
  const EditSellerProfilePage({Key key, this.user}) : super(key: key);
  @override
        ...
        leading: IconButton(
          ...
          onPressed: () {
             Navigator.of(context).push(MaterialPageRoute(
                   builder: (BuildContext context) => ProfileUI3(
                     user: widget.user,
                   )));
          },
        ),
...
void _updateProfile(String name, String country, String phonenum,String email) {
    ...
    setState(() {
      http.post(
      Uri.parse("https://crimsonwebs.com/s272043/storehelper/php/updatesellerporfile.php"),
      body: {
        "email":email,
        "name":name,
        "country":country,
