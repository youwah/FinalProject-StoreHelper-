...
$sqlregister = "INSERT INTO tbl_seller(user_email,password,otp,name,country,phonenum) VALUE('$user_email','$passha1','$otp','$name','$country','$phone')";
...
function sendEmail($otp,$user_email){
    ...
    <a href='https://crimsonwebs.com/s272043/storehelper/php/verify_selleracc.php?email=".$user_email."&key=".$otp."'>Click Here to verify your account</a>";
